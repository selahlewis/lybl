...
import 'package:lybl_mobile/Screens/Widgets/portrait.dart';
import 'package:lybl_mobile/Screens/Widgets/rounded_button.dart';
import 'package:lybl_mobile/Screens/Widgets/rounded_outlined_button.dart';
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/images/tinder_icon.png', width: 40),
              Container(
                child: Row(
