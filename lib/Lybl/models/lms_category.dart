class LmsCategory {
  int _id, _parent, _sortorder, _coursecount;
  int _visible, _visibleold, _timemodified, _depth, _descriptionformat;
  String _name, _idnumber, _description, _path, _theme;
  ...
  int get descriptionformat => _descriptionformat;
  ...
  set descriptionformat(int newDescriptionformat) {
