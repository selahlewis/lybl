class APIConstants {
  ...
  static const String API_BASE_URL = "http://jetclassroom.com/";
}
...
class APIOperations {
  ...
  static const String getRegisterNewUser =
      "webservice/rest/server.php?wsfunction=core_user_create_users&moodlewsrestformat=json";
  ...
  //"webservice/rest/server.php?wsfunction=mod_quiz_get_attempt_data&attemptid=13&page=0&moodlewsrestformat=json";
  ...
  static const String getLesson =
      "webservice/rest/server.php?wsfunction=mod_lesson_get_lesson&lessonid=15&moodlewsrestformat=json";

  static const String getPages =
      "webservice/rest/server.php?wsfunction=mod_lesson_get_page_data&lessonid=15&pageid=3&moodlewsrestformat=json";

  static const String getLessons =
      "webservice/rest/server.php?wsfunction=mod_lesson_get_lessons_by_courses&moodlewsrestformat=json";

  static const String answerEssay =
      "webservice/rest/server.php?wsfunction=mod_lesson_process_page&lessonid=15&pageid=4&review=0&moodlewsrestformat=json";

  static const String getAnswers =
      "webservice/rest/server.php?wsfunction=mod_lesson_get_user_attempt&lessonid=15&userid=1021&lessonattempt=1&moodlewsrestformat=json";
...
class Texts {
  static const String APP_NAME = "LYBL";
